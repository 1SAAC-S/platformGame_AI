...
//SINGLE DIRECTIONAL CONNECTIONS
//NO SIMPLE COLLSION ERROR
            ...
            for (Mood_Node currentNode : theNodes) {
                ...
                for (int dx = -11; dx <= 11; dx++) {
                    for (int dy = -6; dy <= 5; dy++) {
                        ...
                        // Determine if connection is possible based on movement rules
                        if (isConnectionPossible(graphToCreate, currentNode, targetNode, dx, dy)) {
                            currentNode.addConnection(targetNode);
                        }
                    }
                }
            }
        ...
        public void aStar(Mood_Node start, Mood_Node end) {
            ...
            while (!openSet.isEmpty()) {
                ...
                for (int i = 0; i < current.getSize(); i++) {
                    Mood_Node neighbor = current.get(i);
